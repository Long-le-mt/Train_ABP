$(function () {
    ...
    var dataTable = $('#BoPhanTable').DataTable(abp.libs.datatables.normalizeConfiguration({
        ...
        scrollCollapse: true,
        ordering: false,
        ajax: abp.libs.datatables.createAjax(acme.bookStore.commons.boPhan.getList),
        columnDefs: [
            {
...
function Search() {
    ...
    dataTable = $('#BoPhanTable').DataTable(abp.libs.datatables.normalizeConfiguration({
        ...
        scrollCollapse: true,
        ordering: false,
        ajax: abp.libs.datatables.createAjax(acme.bookStore.commons.boPhan.search, function () {
            return input;
        }),
        columnDefs: [
            {
